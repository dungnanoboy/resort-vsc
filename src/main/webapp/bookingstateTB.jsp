...
<%
	...
	BookingStateServiceImpl bsDao = new BookingStateServiceImpl();
	List<BookingStateBean> states = bsDao.getAllBookingState();
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                <%
					for (BookingStateBean state : states) {
				%>
                  <tr>
